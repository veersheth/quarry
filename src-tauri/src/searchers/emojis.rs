...
impl SearchProvider for EmojiSearcher {
    fn search(&self, query: &str) -> SearchResult {
        ...
        let results: Vec<ResultItem> = EMOJI_LIST.iter()
...
pub static EMOJI_LIST: &[(&str, &str)] = &[
    ...
    ("😂", "face with tears of joy face cry tears weep happy happytears haha laughing"),
    ...
    ("😭", "lmao hahaha laughing loudly crying face face cry tears sad upset depressed"),
    ...
    ("😩", "uh ughhhhhhh moan weary face face tired sleepy sad frustrated upset"),
    ...
    ("💀", "lmao what the fuck skull dead skeleton creepy death"),
    ...
    ("🖕", "fuck you bitch middle finger hand fingers rude middle flipping"),
